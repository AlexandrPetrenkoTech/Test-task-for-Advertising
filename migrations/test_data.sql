...
INSERT INTO photos (advert_id, url, is_main) VALUES
                                                 (1, 'https://example.com/iphone.jpg', TRUE),
                                                 (2, 'https://example.com/laptop.jpg', TRUE),
                                                 (3, 'https://example.com/table.jpg', TRUE),
                                                 (4, 'https://example.com/bike1.jpg', TRUE),
                                                 (4, 'https://example.com/bike2.jpg', FALSE),
                                                 (5, 'https://example.com/lamp.jpg', TRUE);